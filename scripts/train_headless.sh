...
FREECIV_REWARD_TENSORBOARD="${FREECIV_REWARD_TENSORBOARD:-0}"
FREECIV_BELIEF_TENSORBOARD="${FREECIV_BELIEF_TENSORBOARD:-0}"
FREECIV_BELIEF_TENSORBOARD_INTERVAL="${FREECIV_BELIEF_TENSORBOARD_INTERVAL:-5}"
FREECIV_BELIEF_TENSORBOARD_DIR="${FREECIV_BELIEF_TENSORBOARD_DIR:-}"
...
# FREECIV_PRODUCTION_QUEUE_ADD="${FREECIV_PRODUCTION_QUEUE_ADD:-1}"
# FREECIV_PRODUCTION_QUEUE_MAX="${FREECIV_PRODUCTION_QUEUE_MAX:-3}"
...
run_with_timing_and_log train_headless python muzero.py freeciv_remote "{
  ...
  \"mcts_wasserstein_power\": ${MUZERO_MCTS_WASSERSTEIN_POWER},
  \"mcts_wasserstein_selection\": \"${MUZERO_MCTS_WASSERSTEIN_SELECTION}\",
  \"mcts_wasserstein_uncertainty_coef\": ${MUZERO_MCTS_WASSERSTEIN_UNCERTAINTY_COEF},
  \"mcts_wasserstein_min_std\": ${MUZERO_MCTS_WASSERSTEIN_MIN_STD},
  \"mcts_wasserstein_shift_epsilon\": ${MUZERO_MCTS_WASSERSTEIN_SHIFT_EPSILON},
  \"env\": {
    ...
    \"FREECIV_CLIENT_CMD\": \"${BUILD_DIR}/run.sh freeciv-gtk3.22 -a -s 127.0.0.1 -p {server_port} -n agent0 -P none -- --resolution ${DISPLAY_SIZE}\",
    \"FREECIV_CLIENT_START_WAIT\": \"${FREECIV_CLIENT_START_WAIT}\",
    \"FREECIV_CLIENT_START_TIMEOUT\": \"${FREECIV_CLIENT_START_TIMEOUT}\",
    \"FREECIV_SERVER_START_TIMEOUT\": \"${FREECIV_SERVER_START_TIMEOUT}\",
    \"FREECIV_PLAYER_ID\": \"0\",
    ...
    \"FREECIV_PRODUCTION_ESTIMATES\": \"${FREECIV_PRODUCTION_ESTIMATES}\",
    \"FREECIV_ACTION_CURRICULUM_STAGE\": \"${FREECIV_ACTION_CURRICULUM_STAGE}\",
    \"FREECIV_ACTION_CURRICULUM_GROUPS\": \"${FREECIV_ACTION_CURRICULUM_GROUPS}\",
    \"FREECIV_ROTATE_PORTS_ON_RESTART\": \"${FREECIV_ROTATE_PORTS_ON_RESTART}\"
  }
}"
