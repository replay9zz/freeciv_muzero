...
FREECIV_PRODUCTION_ESTIMATES="${FREECIV_PRODUCTION_ESTIMATES:-0}"
...
export FREECIV_OBSERVE_BELIEF FREECIV_PRODUCTION_ESTIMATES
export FREECIV_ACTION_CURRICULUM_STAGE FREECIV_ACTION_CURRICULUM_GROUPS
